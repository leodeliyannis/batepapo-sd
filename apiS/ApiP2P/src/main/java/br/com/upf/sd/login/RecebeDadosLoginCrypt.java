...
public class RecebeDadosLoginCrypt implements Runnable {	
	...
	public RecebeDadosLoginCrypt(boolean modoDebug, SecretKey desKey, String ipConexao, int porta) throws SocketException {   
        this.desKey = desKey;  
	...
	public void run() {
		...
		System.out.println("Conexão com o ip : "+ipConexao);
		
		try {
			serverSocket = new DatagramSocket(porta);
			
	        if (modoDebug)
	        	System.out.println("\nPorta "+porta+" aberta para login sem criptografia!");
