...
import br.com.upf.sd.login.RecebeDadosLoginCrypt;
import br.com.upf.sd.types.Argumentos;

public class OrquestradorLoginCrypt extends Thread {
	...
	public OrquestradorLoginCrypt(Argumentos argumentos) {
...
//				diffieHellman.meuIP();
		        ...
		        RecebeDadosLoginCrypt edl = new RecebeDadosLoginCrypt(modoDebug, bobDesKey, ipRecebido, porta);
