...
public class TopicosMaisAcessadosRequest {
	...
	public void validateFields() throws ValidationException {
		...
		JaxbValidator.validateNotNull(this, TopicosMaisAcessadosRequest.class);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TopicosMaisAcessadosRequest other = (TopicosMaisAcessadosRequest) obj;
	...
	public String toString() {
		return "TopicosMaisAcessadosRequest [autenticacao=" + autenticacao + ", datas=" + datas + "]";
	}
}
